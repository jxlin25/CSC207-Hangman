...
public class EndGameResultsInteractorTest {
    ...
    public void testSingleRoundWon() {
        ...
        JsonStatsDataAccessObject statsDao = new JsonStatsDataAccessObject("test_stats_won.json");
        ...
        // Assert
        assertEquals("Final status should be 'You Won the Game!'", "You Won the Game!", presenter.getFinalStatus());
    ...
    public void testSingleRoundLost() {
        ...
        JsonStatsDataAccessObject statsDao = new JsonStatsDataAccessObject("test_stats_lost.json");
        ...
        // Assert
        assertEquals("Final status should be 'You Lost the Game!'", "You Lost the Game!", presenter.getFinalStatus());
    ...
    public void testFiveRoundsMixedResults() {
        ...
        // Set the max attempts on the game entity
        game.setMaxAttempts(6);
